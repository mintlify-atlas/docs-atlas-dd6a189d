---
title: "VinylVibes Authentication: Login and Registration API"
sidebarTitle: "Auth"
description: "POST /login returns a JWT and session metadata. POST /registro creates a new account. Both require nombre_usuario and password in the request body."
---
