---
title: "VinylVibes Search: Full-Text Vinyl Catalog Query API"
sidebarTitle: "Search"
description: "GET /buscar?q={query} searches vinyls by title or artist. The frontend debounces by 500ms and restores /recientes data when the search input is cleared."
---
