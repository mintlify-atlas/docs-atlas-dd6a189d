...
description: "Complete reference for VinylVibes CSS custom properties: color tokens, gradients, borders, radii, shadows, typography, and animation values from style.css."
---
