...
description: "VinylVibes has a single configuration point: the API base URL set in three JavaScript files. Learn how to change it for local development or a custom backend."
---
