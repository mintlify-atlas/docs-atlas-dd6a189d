---
title: "Admin Panel: User Management, Sales, and Statistics"
sidebarTitle: "Admin Panel"
description: "The VinylVibes admin panel shows user management, sales tracking with status updates, statistics pulled from the admin API, and demo read-only mode."
---
...
The **Usuarios** tab shows a table of all registered accounts. Data is fetched once and filtered client-side.
