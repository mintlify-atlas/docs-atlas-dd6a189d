---
title: "User Authentication, Registration, and JWT Sessions"
sidebarTitle: "Authentication"
description: "VinylVibes issues JWT tokens via POST /login, stored in localStorage. POST /registro creates accounts with a 6-character minimum password requirement."
---
...
Call `cerrarSesion()` from anywhere in the catalog page to end the session. It removes the three session-related keys from `localStorage` and updates the navbar to the logged-out state.
