---
title: "Shopping Cart, Checkout, and Order Submission Flow"
sidebarTitle: "Cart & Checkout"
description: "VinylVibes stores cart items in localStorage and syncs across browser tabs. Checkout collects shipping info and card details, then posts to POST /checkout."
---
...
- **"Buy Now" from modal** — `comprarDesdeModal()` reads `discoActivo` and opens the shipping modal directly via `abrirModalEnvio`, bypassing the cart panel entirely.
