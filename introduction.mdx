...
description: "VinylVibes is a static vinyl record store built with HTML5, CSS3, and vanilla JS. Discogs, Last.fm, and YouTube data is proxied through a hosted REST API."
---
