---
title: "Get Started with VinylVibes in Minutes"
sidebarTitle: "Quickstart"
description: "Run VinylVibes locally in three steps — no build tools, no package manager, no configuration required. Just clone and serve."
---
